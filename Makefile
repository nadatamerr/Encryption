...
#$(OBJECTS)/MultiHeadQueue.o: $(SOURCES)/MultiHeadQueue.cpp  $(HEADERS)/MultiHeadQueue.h
#	$(GCC) $(DEBUG) $(INCLUDES) $(GCC_FLAGS) -c $(SOURCES)/MultiHeadQueue.cpp -o $(OBJECTS)/MultiHeadQueue.o
